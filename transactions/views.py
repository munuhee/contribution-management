...
def add_unmatched_transaction(request):
    ...
    return render(request, 'unmatched_transactions/unmatched_transactions_form.html', {'form': form})
...
def update_unmatched_transaction(request, pk):
    ...
    return render(request, 'unmatched_transactions/unmatched_transactions_form.html', {'form': form, 'transaction': transaction})
...
def delete_unmatched_transaction(request, pk):
    ...
    return render(request, 'unmatched_transactions/unmatched_transaction_delete.html', {'transaction': transaction})